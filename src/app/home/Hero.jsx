    ...
    return (
        <div>
            <div className="relative w-full">
                <h1 className="sm:text-[68px] text-[30px] items-center text-[#312F39] w-[60%] mx-auto text-center font-bold relative">
            ...
            <p className="text-center text-[#59565F] mt-2 text-[16px] sm:w-[40%] w-[80%] mx-auto">
